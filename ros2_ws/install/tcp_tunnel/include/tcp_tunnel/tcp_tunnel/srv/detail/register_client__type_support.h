...
#ifndef TCP_TUNNEL__SRV__DETAIL__REGISTER_CLIENT__TYPE_SUPPORT_H_
#define TCP_TUNNEL__SRV__DETAIL__REGISTER_CLIENT__TYPE_SUPPORT_H_
...
#endif  // TCP_TUNNEL__SRV__DETAIL__REGISTER_CLIENT__TYPE_SUPPORT_H_
