...
static const _RemoveTopic_Request_type_support_symbol_names_t _RemoveTopic_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tcp_tunnel, srv, RemoveTopic_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tcp_tunnel, srv, RemoveTopic_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tcp_tunnel, srv, RemoveTopic_Request)() {
  return &::tcp_tunnel::srv::rosidl_typesupport_c::RemoveTopic_Request_message_type_support_handle;
}
...
static const _RemoveTopic_Response_type_support_symbol_names_t _RemoveTopic_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tcp_tunnel, srv, RemoveTopic_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tcp_tunnel, srv, RemoveTopic_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tcp_tunnel, srv, RemoveTopic_Response)() {
  return &::tcp_tunnel::srv::rosidl_typesupport_c::RemoveTopic_Response_message_type_support_handle;
}
...
static const _RemoveTopic_type_support_symbol_names_t _RemoveTopic_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tcp_tunnel, srv, RemoveTopic)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tcp_tunnel, srv, RemoveTopic)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tcp_tunnel, srv, RemoveTopic)() {
  return &::tcp_tunnel::srv::rosidl_typesupport_c::RemoveTopic_service_type_support_handle;
}
